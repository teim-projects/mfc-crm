// src/pages/daycare/membership/AddMembershipPlan.jsx

import { useEffect, useState } from "react";
import API from "../../../api";

export default function AddMembershipPlans({
  isOpen,
  id,
  onClose,
  onSuccess,
  ...
  const fetchPlan = async () => {
    try {
      const res = await API.get(`/daycare/membership-plans/${id}/`);
      setFormData({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (id) {
        await API.put(`/daycare/membership-plans/${id}/`, payload);
        alert("Membership Plan Updated Successfully ✨");
      } else {
        await API.post("/daycare/membership-plans/", payload);
        ...
        <div style={styles.modalHeader}>
          <div style={styles.titleWrapper}>
            <h2 style={styles.title}>
              {id ? "Edit Membership Plan" : "Create Membership Plan"}
            </h2>
            <p style={styles.subtitle}>
              Configure daycare pricing, membership fees and hourly rates.
            </p>
          </div>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          >
            ...
            <div style={{ ...styles.inputContainer, gridColumn: isMobile ? "span 1" : "span 2" }}>
              <label style={styles.fieldLabel}>Membership Plan Name *</label>
              <input
                type="text"
                name="plan_name"
            ...
            <div style={{ ...styles.inputContainer, gridColumn: isMobile ? "span 1" : "initial" }}>
              <label style={styles.fieldLabel}>Monthly Membership Fee (₹) *</label>
              <input
                type="number"
                step="0.01"
                name="monthly_fee"
            ...
            <div style={{ ...styles.inputContainer, gridColumn: isMobile ? "span 1" : "span 2" }}>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Add membership notes, benefits or pricing details..."
