...
import AddDaycareStudent from "./AddDaycareStudent";

export default function DaycareStudents() {
  ...
  const fetchStudents = async () => {
    try {
      const res = await api.get("/daycare/daycare-students/");
  ...
  try {
    ...
    await api.delete(
      `/daycare/daycare-students/${id}/delete/`
    );
        ...
        <div style={{
          ...
          <div style={styles.titleSection}>
            <div style={styles.headingWrapper}>
              ...
              <h2 style={styles.title}>Daycare Students</h2>
            </div>
            <p style={styles.subtitle}>
              Manage student enrollment profiles, primary parent details, and calculated hour logs.
            </p>
          </div>
          ...
          <div style={{
            ...
            <button 
              ...
              onClick={() => navigate("/daycare-services")}
            >
              💼 Services
            </button>
            <button 
            ...
            <table style={styles.table}>
              <thead>
                <tr>
                  ...
                  <th style={styles.th}>Hours/Day</th>
              ...
              <tbody>
                {paginatedStudents.map((s) => (
                  <tr key={s.id} style={styles.tr}>
                    ...
                    <td style={{ ...styles.td, color: "var(--text-main)", fontWeight: "500" }}>
                      {s.parent_name || "—"}
                    </td>
                    <td style={{ ...styles.td, color: "var(--text-muted)", fontFamily: "monospace" }}>
                      {s.mobile_no || "—"}
                    </td>
    ...
    >
      Delete
            ...
            <div style={styles.emptyState}>
              <p>No student enrollment records found matching the current search criteria.</p>
            </div>
          )}
        </div>
...
const styles = {
  ...
  recordBtn: {
    background: "var(--bg-layout)", color: "#6080E8", border: "1px solid #6080E8", padding: "6px 12px",
