                ...
                <tbody>
                  {receipt.items.map((item, index) => (
                    <tr key={item.id} style={styles.tr}>
                      ...
                      <td style={{ ...styles.td, fontWeight: "600", color: "#1e293b" }}>₹{parseFloat(item.amount).toFixed(2)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
...
const styles = {
  ...
  backButton: { background: "#fff", color: "#475569", border: "1px solid #cbd5e1", padding: "10px 16px", borderRadius: "6px", cursor: "pointer", fontWeight: "600", fontSize: "13px", whiteSpace: "nowrap", textAlign: "center", boxSizing: "border-box" },
  receiptCard: { background: "#fff", borderRadius: "12px", border: "1px solid #e2e8f0", overflow: "hidden", boxShadow: "0 1px 3px rgba(0,0,0,0.02)" },
  receiptHeader: { background: "linear-gradient(135deg, #6080E8 0%, #4a6ad8 100%)", padding: "24px", color: "#fff", display: "flex", justifyContent: "space-between", boxSizing: "border-box" },
  schoolName: { fontSize: "20px", fontWeight: "700", margin: 0 },
  receiptBadge: { background: "rgba(255,255,255,0.2)", padding: "8px 16px", borderRadius: "8px", fontSize: "13px", fontWeight: "700", fontFamily: "monospace", letterSpacing: "0.02em" },
  infoGrid: { display: "grid", gap: "20px", padding: "24px", borderBottom: "1px solid #e2e8f0" },
  infoItem: { display: "flex", flexDirection: "column", gap: "4px" },
  infoLabel: { fontSize: "11px", color: "#94a3b8", textTransform: "uppercase", letterSpacing: "0.05em", fontWeight: "700" },
  infoValue: { fontSize: "15px", fontWeight: "600", color: "#1e293b" },
  itemsSection: { padding: "24px" },
  itemsTitle: { fontSize: "14px", fontWeight: "700", color: "#475569", textTransform: "uppercase", letterSpacing: "0.02em", marginBottom: "16px" },
  ...
  th: { background: "#f8fafc", padding: "12px 14px", textAlign: "left", fontSize: "11px", fontWeight: "700", color: "#475569", textTransform: "uppercase", letterSpacing: "0.05em", borderBottom: "1px solid #e2e8f0", whiteSpace: "nowrap" },
  tr: { borderBottom: "1px solid #f1f5f9" },
  td: { padding: "12px 14px", fontSize: "14px", color: "#475569", verticalAlign: "middle", whiteSpace: "nowrap" },
  productName: { fontWeight: "600", color: "#1e293b" },
  itemRemarks: { fontSize: "11px", color: "#64748b", marginTop: "4px" },
  summarySection: { padding: "24px", borderTop: "1px solid #e2e8f0", background: "#f8fafc", width: "100%", boxSizing: "border-box", marginLeft: "auto", display: "flex", flexDirection: "column", gap: "8px" },
  summaryRow: { display: "flex", justifyContent: "space-between", alignItems: "center" },
  summaryLabel: { fontSize: "13px", color: "#64748b", fontWeight: "500" },
  summaryValue: { fontSize: "13px", color: "#1e293b", fontWeight: "600" },
  grandTotalRow: { marginTop: "4px", paddingTop: "12px", borderTop: "1px dashed #cbd5e1" },
  grandTotalLabel: { fontSize: "14px", color: "#0f172a", fontWeight: "700" },
  grandTotal: { color: "#6080E8", fontSize: "18px", fontWeight: "700" },
  loading: { textAlign: "center", padding: "50px", fontSize: "16px", color: "#64748b" },
  error: { textAlign: "center", padding: "50px", fontSize: "16px", color: "#dc2626", fontWeight: "500" },
};